...
syn_input_data = np.loadtxt('/home/csgrad/anant/ML_project2/input.csv', delimiter=',')
syn_output_data = np.loadtxt('/home/csgrad/anant/ML_project2/output.csv', delimiter=',').reshape([-1, 1])
...
letor_input_data = np.genfromtxt('/home/csgrad/anant/ML_project2/Querylevelnorm_X.csv', delimiter=',')
letor_output_data = np.genfromtxt('/home/csgrad/anant/ML_project2/Querylevelnorm_t.csv', delimiter=',').reshape([-1, 1])
...
print("KClose_syn", paramsClose_letor[0])
